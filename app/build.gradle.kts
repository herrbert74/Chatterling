...
android {
	...
	namespace = "com.zsoltbertalan.chatterling"

	defaultConfig {
		applicationId = "com.zsoltbertalan.chatterling"
		...
		compileSdk = 34
		targetSdk = 34
		testInstrumentationRunner = "com.zsoltbertalan.chatterling.ChatterlingAndroidJUnitRunner"
	}
