package com.zsoltbertalan.chatterling.design
...
val ChatterlingLightColorScheme = lightColorScheme(
...
private val ChatterlingDarkColorScheme = darkColorScheme(
...
private val LocalAppColors = staticCompositionLocalOf {
	ChatterlingLightColorScheme
}

@Composable
fun ChatterlingTheme(
	...
	val colorScheme = when {
		...
		isDarkTheme -> ChatterlingDarkColorScheme
		else -> ChatterlingLightColorScheme
	}
	...
	ProvideDimens(dimensions = dimensions) {
		ProvideColors(colorScheme = colorScheme) {
			MaterialTheme(
				colorScheme = colorScheme,
				typography = ChatterlingTypography,
				content = content
			)
		}
	}
...
val Dimens: Dimensions
	@Composable
	get() = ChatterlingTheme.dimens

val Colors: ColorScheme
	@Composable
	get() = ChatterlingTheme.colorScheme
